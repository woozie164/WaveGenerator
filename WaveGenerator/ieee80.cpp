...
double ieee80::myUlongToDouble(unsigned long ul)
{
	double val;
...
unsigned long ieee80::myDoubleToUlong(double	val)
{
	unsigned long ul;
...
*/
double ieee80::ieee_80_to_double(unsigned char *p)
{
	char sign;
	short exp = 0;
...
void ieee80::double_to_ieee_80(double val,unsigned char *p)
{
	char sign = 0;
	short exp = 0;
	unsigned long mant1 = 0;
